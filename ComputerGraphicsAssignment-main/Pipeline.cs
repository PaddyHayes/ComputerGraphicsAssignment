...
public class Pipeline : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        Matrix4x4 ScaleMatrix = Matrix4x4.TRS(Vector3.zero, Quaternion.identity, new Vector3(5, 2, 1));
    ...
    private List<Vector3> get_image(List<Vector3> list_verts, Matrix4x4 transform_matrix)
    {
        ...
        {
            hold.Add(transform_matrix * new Vector4(v.x,v.y,v.z,1));
        }
        return hold;
